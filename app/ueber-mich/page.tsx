  ...
  return (
    <div className="bg-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-4xl font-bold text-gray-900 mb-8 text-center">Über mich</h1>
        ...
        <div className="prose prose-lg mx-auto text-gray-600">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">Mein musikalischer Werdegang</h2>
          <p className="mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">Unterrichtserfahrung</h2>
          <p className="mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">Meine Philosophie</h2>
          <p className="mb-6">
